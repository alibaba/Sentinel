 ...
 */
package com.alibaba.csp.sentinel.dashboard.web.controller.cluster;

import com.alibaba.csp.sentinel.cluster.ClusterStateManager;
import com.alibaba.csp.sentinel.dashboard.common.util.SentinelVersion;
import com.alibaba.csp.sentinel.dashboard.common.util.VersionUtils;
import com.alibaba.csp.sentinel.dashboard.entity.discovery.AppManagement;
import com.alibaba.csp.sentinel.dashboard.web.client.CommandNotFoundException;
import com.alibaba.csp.sentinel.dashboard.web.domain.Result;
import com.alibaba.csp.sentinel.dashboard.web.domain.cluster.request.ClusterClientModifyRequest;
import com.alibaba.csp.sentinel.dashboard.web.domain.cluster.request.ClusterModifyRequest;
import com.alibaba.csp.sentinel.dashboard.web.domain.cluster.request.ClusterServerModifyRequest;
import com.alibaba.csp.sentinel.dashboard.web.domain.cluster.state.AppClusterClientStateWrapVO;
import com.alibaba.csp.sentinel.dashboard.web.domain.cluster.state.AppClusterServerStateWrapVO;
import com.alibaba.csp.sentinel.dashboard.web.domain.cluster.state.ClusterUniversalStatePairVO;
import com.alibaba.csp.sentinel.dashboard.web.domain.cluster.state.ClusterUniversalStateVO;
import com.alibaba.csp.sentinel.dashboard.web.service.ClusterConfigService;
import com.alibaba.csp.sentinel.dashboard.web.service.util.ClusterEntityUtils;
