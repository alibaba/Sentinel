...
public class NacosFlowRuleDynamicRule implements DynamicRule<List<FlowRuleEntity>>
{
     ...
     * @param encoder
     */
    public NacosFlowRuleDynamicRule(NacosConfigProperties nacosConfigProperties, ConfigService configService,
            Converter<List<FlowRuleEntity>, String> encoder, Converter<String, List<FlowRuleEntity>> decoder)
    {
    ...
    {
        String rules = configService.getConfig(appName + nacosConfigProperties.getFlowSuffix(),
    ...
    public void publish(String app, List<FlowRuleEntity> rules) throws Exception
    {
        ...
        configService.publishConfig(app + nacosConfigProperties.getFlowSuffix(),
