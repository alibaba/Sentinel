...
public class NacosConfig {
    ...
    public ConfigService nacosConfigService() throws Exception {
        // 多个 ip 用逗号隔开
        String nacosServerIps = System.getProperty("nacos.server.ip");
        if (StringUtil.isBlank(nacosServerIps)) {
            nacosServerIps = "localhost";
        }

        return ConfigFactory.createConfigService(nacosServerIps);
    }
}
