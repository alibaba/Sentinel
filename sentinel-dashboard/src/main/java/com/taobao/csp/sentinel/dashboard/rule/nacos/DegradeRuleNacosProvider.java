 ...
 */
public class DegradeRuleNacosProvider implements BaseDynamicRuleNacosProvider<DegradeRuleEntity> {
    private ConfigService configService;
    private Converter<String, List<DegradeRuleEntity>> decoder;

    public DegradeRuleNacosProvider(ConfigService configService, Converter<String, List<DegradeRuleEntity>> decoder) {
