 ...
 */
public class SystemRuleNacosPublisher implements BaseDynamicRuleNacosPublisher<SystemRuleEntity> {
    private ConfigService configService;
    private Converter<List<SystemRuleEntity>, String> encoder;

    public SystemRuleNacosPublisher(ConfigService configService, Converter<List<SystemRuleEntity>, String> encoder) {
