 ...
 */
public class FlowRuleNacosPublisher implements BaseDynamicRuleNacosPublisher<FlowRuleEntity> {
    private ConfigService configService;
    private Converter<List<FlowRuleEntity>, String> encoder;

    public FlowRuleNacosPublisher(ConfigService configService, Converter<List<FlowRuleEntity>, String> encoder) {
