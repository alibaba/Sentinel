 ...
 */
public class ParamFlowRuleNacosProvider implements BaseDynamicRuleNacosProvider<ParamFlowRuleEntity> {
    private ConfigService configService;
    private Converter<String, List<ParamFlowRuleEntity>> decoder;

    public ParamFlowRuleNacosProvider(ConfigService configService,
                                      Converter<String, List<ParamFlowRuleEntity>> decoder) {
    ...
    public String getPostfix() {
        return NacosConfigUtil.PARAMETER_FLOW_DATA_ID_POSTFIX;
    }
}
