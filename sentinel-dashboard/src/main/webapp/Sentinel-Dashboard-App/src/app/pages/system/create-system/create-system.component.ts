...
export class CreateSystemComponent implements OnInit {
  ...
  public handleChangeSThK(): void {
    this.systemRuleForm.controls.thresholdValue.patchValue(null);
  }
  ...
  public handleOk(): void {
    ...
    this.kieSystemService.createKieSystemRule(this.service_id, params).subscribe(res => {
      if (res.success) {
        ...
        this.message.success('新增系统保护规则成功');
      } else {
        this.isOkLoading = false;
        this.isVisible = false;
        this.creModClose.emit({
