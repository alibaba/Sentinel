...
}]), (app = angular.module("sentinelDashboardApp")).service("VersionService", ["$http", function (e) {
    this.version = function () {
        return e({url: "/version", method: "GET"})
    }
}]), (app = angular.module("sentinelDashboardApp")).service("AuthService", ["$http", function (t) {
    this.check = function () {
        return t({url: "/auth/check", method: "POST"})
...
}]), (app = angular.module("sentinelDashboardApp")).service("MetricService", ["$http", function (l) {
    this.queryAppSortedIdentities = function (e) {
        return l({url: "/metric/queryTopResourceMetric.json", params: e, method: "GET"})
    }, this.queryByAppAndIdentity = function (e) {
        return l({url: "/metric/queryByAppAndResource.json", params: e, method: "GET"})
    }, this.queryByMachineAndIdentity = function (e, t, r, a, o) {
        var i = {ip: e, port: t, identity: r, startTime: a.getTime(), endTime: o.getTime()};
        return l({url: "/metric/queryByAppAndResource.json", params: i, method: "GET"})
    }
