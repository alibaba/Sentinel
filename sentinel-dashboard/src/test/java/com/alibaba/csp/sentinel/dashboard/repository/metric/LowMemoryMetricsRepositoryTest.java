...
/**
 * Test cases for {@link LowMemoryMetricsRepository}.
 *
 * @author luoxy
 * @since 2020-06-08 15:23/1.0
 */
public class LowMemoryMetricsRepositoryTest {
    ...
    private LowMemoryMetricsRepository lowMemoryMetricsRepository;
    private ExecutorService executorService;

    @Before
    public void setUp() throws Exception {
        lowMemoryMetricsRepository = new LowMemoryMetricsRepository();
    ...
    public void testSave() {
        ...
        lowMemoryMetricsRepository.save(entry);
        List<String> resources = lowMemoryMetricsRepository.listResourcesOfApp("testSave");
    ...
    public void testSaveAll() {
        ...
        lowMemoryMetricsRepository.saveAll(entities);
        List<String> result = lowMemoryMetricsRepository.listResourcesOfApp("testSaveAll");
    ...
    public void testExpireMetric() {
        ...
        lowMemoryMetricsRepository.save(expireEntry);
        ...
        List<MetricEntity> list = lowMemoryMetricsRepository.queryByAppAndResourceBetween(
            ...
            futures.add(CompletableFuture.runAsync(() -> {
                        try {
                            ...
                            if (finalJ % 2 == 0) {
                                ...
                                lowMemoryMetricsRepository.listResourcesOfApp(DEFAULT_APP);
                            }
