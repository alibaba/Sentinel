...
/**
 * A traffic runner to simulate degrade for different parameters.
 *
 */
class ParamDegradeQpsRunner<T> {
    ...
    public ParamDegradeQpsRunner(T[] params, String resourceName, int threadCount, int seconds) {
