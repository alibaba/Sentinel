...
public class EtcdDataSourceDemo {
    ...
    public static void main(String[] args) {
        ...
        ReadableDataSource<String, List<FlowRule>> flowRuleEtcdDataSource = new EtcdDataSource<>(rule_key, (rule) -> JsonTransformerLoader.deserializer().deserialize(rule, new TypeReference<List<FlowRule>>() {}.getType()));
