...
import com.alibaba.csp.sentinel.adapter.mybatis.SentinelCommandTypeInterceptor;
 ...
 * @author kaizi2009
 */
public class TestCommandTypeInterceptor extends BaseJunit {

    @Test
    public void testCommandTypeInterceptor() {
        String resourceName = SentinelCommandTypeInterceptor.RESOURCE_NAME_PREFIX + SqlCommandType.SELECT.name();
