 ...
 */
public interface PrioritizedRequestBlockStrategy {
    /**
     * strategy to do with the block prioritized request.
     *
     ...
     */
    boolean doWithBlockStrategy(FlowRule rule, Context context, DefaultNode node, int acquireCount, boolean prioritized);
}
