 ...
 */
public class BasicExportListener extends SentinelEventListener {
    ...
    public List<Class<? extends SentinelEvent>> eventType() {
        return Arrays.asList(FlowBlockEvent.class, SystemBlockEvent.class, CircuitBreakerStateEvent.class,
                AuthorityBlockEvent.class, ClusterFlowStateEvent.class, ClusterFallbackEvent.class);
    }
