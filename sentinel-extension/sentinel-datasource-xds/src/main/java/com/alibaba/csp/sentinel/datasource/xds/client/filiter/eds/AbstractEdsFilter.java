 ...
 */
package com.alibaba.csp.sentinel.datasource.xds.client.filiter.eds;
 ...
 * @since 2.0.0
 */
public abstract class AbstractEdsFilter implements XdsFilter<List<ClusterLoadAssignment>> {
