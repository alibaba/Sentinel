...
import com.alibaba.csp.sentinel.slots.hotspot.HotParamSlot;
import com.alibaba.csp.sentinel.slots.hotspot.HotParameterMetric;

/**
 * @author Eric Zhao
 * @since 0.2.0
 */
public class HotParamStatisticEntryCallback implements ProcessorSlotEntryCallback<DefaultNode> {
    ...
    public void onPass(Context context, ResourceWrapper resourceWrapper, DefaultNode node, int count, Object... args)
        ...
        if (hotParameterMetric != null) {
            hotParameterMetric.addPass(count, args);
            hotParameterMetric.addThreadCount(args);
        }
    }
    ...
    public void onBlocked(BlockException ex, Context context, ResourceWrapper resourceWrapper, DefaultNode param,
        ...
        // We add the block count when throwing the HotParamException instead.
    }
}
