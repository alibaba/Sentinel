 ...
 * @since 0.2.0
 */
@CommandMapping(name = "hotParams")
public class FetchTopHotParamsCommandHandler implements CommandHandler<String> {
    ...
    public CommandResponse<String> handle(CommandRequest request) {
        ...
        HotParameterMetric metric = HotParamSlot.getHotParamMetricForName(resourceName);
        if (metric == null) {
