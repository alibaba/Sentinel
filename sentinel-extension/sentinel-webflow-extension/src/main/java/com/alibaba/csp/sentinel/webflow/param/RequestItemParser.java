...
public interface RequestItemParser<T> {
     ...
     *
     * @param request valid request
     * @param key     valid header key (ignoring case considerations)
     * @return the header
     */
    ...
    /**
     * Get the body value associated with the body name.
     *
     * @param request  valid request
     * @param bodyName valid body name
     * @return the cookie value
     * @since 1.12.0
     */
    String getBodyValue(T request, String bodyName);

    /**
     * Get the path value associated with the parameter name.
     *
     * @param request  valid request
     * @param pathName valid parameter name
     * @return the path value
     */
    String getPathValue(T request, String pathName);
}
