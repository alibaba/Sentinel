package com.alibaba.edas.acm.exception;
...
public class ConfigException extends Exception {
	...
	public ConfigException(int errCode, String errMsg) {
		this.errCode = errCode;
		this.errMsg = errMsg;
	}

	public ConfigException(int errCode, String errMsg, Throwable cause) {
		super(errMsg, cause);
		this.errCode = errCode;
		this.errMsg = errMsg;
	}
