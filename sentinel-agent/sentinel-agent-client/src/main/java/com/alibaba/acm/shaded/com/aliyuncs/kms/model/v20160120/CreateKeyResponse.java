...
import com.alibaba.acm.shaded.com.aliyuncs.kms.transform.v20160120.CreateKeyResponseUnmarshaller;
 ...
 * @version 
 */
public class CreateKeyResponse extends AcsResponse {
	...
	@Override
	public CreateKeyResponse getInstance(UnmarshallerContext context) {
		return	CreateKeyResponseUnmarshaller.unmarshall(this, context);
	}
}
