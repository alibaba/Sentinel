...
public class ImportKeyMaterialRequest extends RpcAcsRequest<ImportKeyMaterialResponse> {
	...
	public void setImportToken(String importToken) {
		...
		if(importToken != null){
			putQueryParameter("ImportToken", importToken);
		}
	}
	...
	public void setEncryptedKeyMaterial(String encryptedKeyMaterial) {
		...
		if(encryptedKeyMaterial != null){
			putQueryParameter("EncryptedKeyMaterial", encryptedKeyMaterial);
		}
	}
	...
	public void setKeyMaterialExpireUnix(Long keyMaterialExpireUnix) {
		...
		if(keyMaterialExpireUnix != null){
			putQueryParameter("KeyMaterialExpireUnix", keyMaterialExpireUnix.toString());
		}
	}
