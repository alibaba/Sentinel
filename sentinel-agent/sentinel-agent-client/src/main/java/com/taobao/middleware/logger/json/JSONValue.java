...
import com.taobao.middleware.logger.json.parser.JSONParser;
import com.taobao.middleware.logger.json.parser.ParseException;
...
public class JSONValue {
	 ...
	 * 
	 * @see com.taobao.middleware.logger.jsonparser.JSONParser#parse(Reader)
	 * @see #parseWithException(Reader)
	 * 
	 * @param in
	 * @return Instance of the following:
	 *	com.taobao.middleware.logger.jsonJSONObject,
	 * 	com.taobao.middleware.logger.jsonJSONArray,
	 * 	java.lang.String,
	 * 	java.lang.Number,
	 * 	java.lang.Boolean,
	 * 	null
	 ...
	 * Parse JSON text into java object from the input source.
	 * 
	 * @see com.taobao.middleware.logger.jsonparser.JSONParser
	 * 
	 * @param in
	 * @return Instance of the following:
	 * 	com.taobao.middleware.logger.jsonJSONObject,
     ...
     * 
     * @see com.taobao.middleware.logger.jsonJSONObject#writeJSONString(Map, Writer)
     * @see com.taobao.middleware.logger.jsonJSONArray#writeJSONString(List, Writer)
     * 
     * @param value
     * @param writer
     */
	 ...
	 * 
	 * @see com.taobao.middleware.logger.json.JSONObject#toJSONString(Map)
	 *
	 * @param value
