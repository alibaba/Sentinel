...
import com.taobao.csp.third.com.alibaba.fastjson.parser.DefaultJSONParser.ResolveTask;
import com.taobao.csp.third.com.alibaba.fastjson.parser.deserializer.DefaultFieldDeserializer;
...
import com.taobao.csp.third.com.alibaba.fastjson.parser.deserializer.MapDeserializer;
import com.taobao.csp.third.com.alibaba.fastjson.parser.deserializer.ObjectDeserializer;
import com.taobao.csp.third.com.alibaba.fastjson.util.FieldInfo;
import com.taobao.csp.third.com.alibaba.fastjson.util.JavaBeanInfo;
...
public class JavaBeanDeserializer implements ObjectDeserializer {
                ...
                if (!matchField) {
                    ...
                    if ((typeKey != null && typeKey.equals(key))
                        ...
                        if (lexer.token() == JSONToken.LITERAL_STRING) {
                            ...
                            if (deserializer instanceof com.taobao.csp.third.com.alibaba.fastjson.parser.deserializer.JavaBeanDeserializer) {
                                com.taobao.csp.third.com.alibaba.fastjson.parser.deserializer.JavaBeanDeserializer javaBeanDeserializer = (com.taobao.csp.third.com.alibaba.fastjson.parser.deserializer.JavaBeanDeserializer) deserializer;
                                if (typeKey != null) {
            ...
            for (int i = 0; i < this.sortedFieldDeserializers.length; i++) {
                ...
                if (fieldInfo.unwrapped //
                    ...
                    if (fieldInfo.field != null) {
                        ...
                        if (fieldValueDeser instanceof com.taobao.csp.third.com.alibaba.fastjson.parser.deserializer.JavaBeanDeserializer) {
                            com.taobao.csp.third.com.alibaba.fastjson.parser.deserializer.JavaBeanDeserializer javaBeanFieldValueDeserializer = (com.taobao.csp.third.com.alibaba.fastjson.parser.deserializer.JavaBeanDeserializer) fieldValueDeser;
                            ...
                            if (unwrappedFieldDeser != null) {
                                ...
                                try {
                                    ...
                                    if (fieldObject == null) {
                                        fieldObject = ((com.taobao.csp.third.com.alibaba.fastjson.parser.deserializer.JavaBeanDeserializer) fieldValueDeser).createInstance(parser, fieldInfo.fieldType);
    ...
    protected com.taobao.csp.third.com.alibaba.fastjson.parser.deserializer.JavaBeanDeserializer getSeeAlso(ParserConfig config, JavaBeanInfo beanInfo, String typeName) {
        if (beanInfo.jsonType == null) {
            return null;
        }
        ...
        for (Class<?> seeAlsoClass : beanInfo.jsonType.seeAlso()) {
            ...
            if (seeAlsoDeser instanceof com.taobao.csp.third.com.alibaba.fastjson.parser.deserializer.JavaBeanDeserializer) {
                com.taobao.csp.third.com.alibaba.fastjson.parser.deserializer.JavaBeanDeserializer seeAlsoJavaBeanDeser = (com.taobao.csp.third.com.alibaba.fastjson.parser.deserializer.JavaBeanDeserializer) seeAlsoDeser;
                ...
                com.taobao.csp.third.com.alibaba.fastjson.parser.deserializer.JavaBeanDeserializer subSeeAlso = getSeeAlso(config, subBeanInfo, typeName);
                if (subSeeAlso != null) {
                    return subSeeAlso;
                }
            }
