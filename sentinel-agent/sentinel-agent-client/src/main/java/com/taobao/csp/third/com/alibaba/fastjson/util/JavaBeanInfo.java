...
import com.taobao.csp.third.com.alibaba.fastjson.annotation.JSONCreator;
import com.taobao.csp.third.com.alibaba.fastjson.annotation.JSONField;
import com.taobao.csp.third.com.alibaba.fastjson.annotation.JSONPOJOBuilder;
...
public class JavaBeanInfo {
    ...
    public static com.taobao.csp.third.com.alibaba.fastjson.util.JavaBeanInfo build(Class<?> clazz, Type type, PropertyNamingStrategy propertyNamingStrategy) {
        return build(clazz, type, propertyNamingStrategy, false, TypeUtils.compatibleWithJavaBean, false);
    }

    public static com.taobao.csp.third.com.alibaba.fastjson.util.JavaBeanInfo build(Class<?> clazz //
            , Type type //
    ...
    public static com.taobao.csp.third.com.alibaba.fastjson.util.JavaBeanInfo build(Class<?> clazz //
        ...
        if (fieldBased) {
            ...
            return new com.taobao.csp.third.com.alibaba.fastjson.util.JavaBeanInfo(clazz, builderClass, defaultConstructor, null, factoryMethod, buildMethod, jsonType, fieldList);
        }
        ...
        if ((defaultConstructor == null && builderClass == null) || isInterfaceOrAbstract) {
            ...
            if (creatorConstructor != null && !isInterfaceOrAbstract) { // 基于标记 JSONCreator 注解的构造方法
                ...
                if (types.length > 0) {
                    ...
                    return new com.taobao.csp.third.com.alibaba.fastjson.util.JavaBeanInfo(clazz, builderClass, null, null, factoryMethod, null, jsonType, fieldList);
                }
                ...
                if (paramNames != null
                    ...
                    if ((!kotlin)
                        ...
                        return new com.taobao.csp.third.com.alibaba.fastjson.util.JavaBeanInfo(clazz, builderClass, null, creatorConstructor, null, null, jsonType, fieldList);
                    }
                } else {
        ...
        return new com.taobao.csp.third.com.alibaba.fastjson.util.JavaBeanInfo(clazz, builderClass, defaultConstructor, creatorConstructor, factoryMethod, buildMethod, jsonType, fieldList);
    }
