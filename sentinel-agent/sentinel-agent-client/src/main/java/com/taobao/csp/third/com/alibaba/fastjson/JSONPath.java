...
import com.taobao.csp.third.com.alibaba.fastjson.JSONPathException;
import com.taobao.csp.third.com.alibaba.fastjson.parser.*;
import com.taobao.csp.third.com.alibaba.fastjson.parser.deserializer.FieldDeserializer;
...
import com.taobao.csp.third.com.alibaba.fastjson.serializer.FieldSerializer;
...
public class JSONPath implements JSONAware {
    private static ConcurrentMap<String, com.taobao.csp.third.com.alibaba.fastjson.JSONPath> pathCache  = new ConcurrentHashMap<String, com.taobao.csp.third.com.alibaba.fastjson.JSONPath>(128, 0.75f, 1);
...
//
    ...
    public static Object eval(Object rootObject, String path) {
        com.taobao.csp.third.com.alibaba.fastjson.JSONPath jsonpath = compile(path);
    ...
    public static com.taobao.csp.third.com.alibaba.fastjson.JSONPath compile(String path) {
        if (path == null) {
            throw new JSONPathException("jsonpath can not be null");
        }

        com.taobao.csp.third.com.alibaba.fastjson.JSONPath jsonpath = pathCache.get(path);
        if (jsonpath == null) {
            jsonpath = new com.taobao.csp.third.com.alibaba.fastjson.JSONPath(path);
    ...
    interface Segment {
        ...
        Object eval(com.taobao.csp.third.com.alibaba.fastjson.JSONPath path, Object rootObject, Object currentObject);
        void extract(com.taobao.csp.third.com.alibaba.fastjson.JSONPath path, DefaultJSONParser parser, Context context);
    }
    ...
    static class SizeSegment implements Segment {
        ...
        public Integer eval(com.taobao.csp.third.com.alibaba.fastjson.JSONPath path, Object rootObject, Object currentObject) {
            return path.evalSize(currentObject);
        }

        public void extract(com.taobao.csp.third.com.alibaba.fastjson.JSONPath path, DefaultJSONParser parser, Context context) {
            throw new UnsupportedOperationException();
        }
    }
    ...
    static class MaxSegment implements Segment {
        ...
        public Object eval(com.taobao.csp.third.com.alibaba.fastjson.JSONPath path, Object rootObject, Object currentObject) {
            Object max = null;
    ...
    static class PropertySegment implements Segment {
        ...
        public void setValue(com.taobao.csp.third.com.alibaba.fastjson.JSONPath path, Object parent, Object value) {
            if (deep) {
        ...
        public boolean remove(com.taobao.csp.third.com.alibaba.fastjson.JSONPath path, Object parent) {
...
//            }
    ...
    static class ArrayAccessSegment implements Segment {
        ...
        public boolean setValue(com.taobao.csp.third.com.alibaba.fastjson.JSONPath path, Object currentObject, Object value) {
            return path.setArrayItem(path, currentObject, index, value);
        }

        public boolean remove(com.taobao.csp.third.com.alibaba.fastjson.JSONPath path, Object currentObject) {
    ...
    static class NotNullSegement implements Filter {
        ...
        public boolean apply(com.taobao.csp.third.com.alibaba.fastjson.JSONPath path, Object rootObject, Object currentObject, Object item) {
    ...
    interface Filter {
        ...
        boolean apply(com.taobao.csp.third.com.alibaba.fastjson.JSONPath path, Object rootObject, Object currentObject, Object item);
    }
    ...
    public boolean setArrayItem(com.taobao.csp.third.com.alibaba.fastjson.JSONPath path, Object currentObject, int index, Object value) {
        if (currentObject instanceof List) {
            List list = (List) currentObject;
            if (index >= 0) {
    ...
    @SuppressWarnings("rawtypes")
    public boolean removeArrayItem(com.taobao.csp.third.com.alibaba.fastjson.JSONPath path, Object currentObject, int index) {
        if (currentObject instanceof List) {
            List list = (List) currentObject;
            if (index >= 0) {
                if (index >= list.size()) {
    ...
    public static Object reserveToArray(Object object, String... paths) {
        ...
        for (String item : paths) {
            com.taobao.csp.third.com.alibaba.fastjson.JSONPath path = com.taobao.csp.third.com.alibaba.fastjson.JSONPath.compile(item);
            path.init();
