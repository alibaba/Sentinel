package com.taobao.csp.third.com.alibaba.fastjson.support.retrofit;
...
import com.taobao.csp.third.com.alibaba.fastjson.support.config.FastJsonConfig;
...
public class Retrofit2ConverterFactory extends Converter.Factory {
    ...
    public static com.taobao.csp.third.com.alibaba.fastjson.support.retrofit.Retrofit2ConverterFactory create() {
        return create(new FastJsonConfig());
    }

    public static com.taobao.csp.third.com.alibaba.fastjson.support.retrofit.Retrofit2ConverterFactory create(FastJsonConfig fastJsonConfig) {
        if (fastJsonConfig == null) throw new NullPointerException("fastJsonConfig == null");
        return new com.taobao.csp.third.com.alibaba.fastjson.support.retrofit.Retrofit2ConverterFactory(fastJsonConfig);
    }
    ...
    public com.taobao.csp.third.com.alibaba.fastjson.support.retrofit.Retrofit2ConverterFactory setFastJsonConfig(FastJsonConfig fastJsonConfig) {
        this.fastJsonConfig = fastJsonConfig;
        return this;
    }
     ...
     */
    @Deprecated
    public com.taobao.csp.third.com.alibaba.fastjson.support.retrofit.Retrofit2ConverterFactory setParserConfig(ParserConfig config) {
     ...
     */
    @Deprecated
    public com.taobao.csp.third.com.alibaba.fastjson.support.retrofit.Retrofit2ConverterFactory setParserFeatureValues(int featureValues) {
        return this;
    }
     ...
     */
    @Deprecated
    public com.taobao.csp.third.com.alibaba.fastjson.support.retrofit.Retrofit2ConverterFactory setParserFeatures(Feature[] features) {
     ...
     */
    @Deprecated
    public com.taobao.csp.third.com.alibaba.fastjson.support.retrofit.Retrofit2ConverterFactory setSerializeConfig(SerializeConfig serializeConfig) {
     ...
     */
    @Deprecated
    public com.taobao.csp.third.com.alibaba.fastjson.support.retrofit.Retrofit2ConverterFactory setSerializerFeatures(SerializerFeature[] features) {
