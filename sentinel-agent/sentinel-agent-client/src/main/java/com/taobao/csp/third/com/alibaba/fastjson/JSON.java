...
import com.taobao.csp.third.com.alibaba.fastjson.parser.deserializer.ExtraProcessor;
import com.taobao.csp.third.com.alibaba.fastjson.parser.deserializer.ExtraTypeProvider;
import com.taobao.csp.third.com.alibaba.fastjson.parser.deserializer.FieldTypeResolver;
 ...
 * {@link #toJSONString(Object)} or {@link #parseObject(String, Type, com.taobao.csp.third.com.alibaba.fastjson.parser.Feature[])} method.  Here is an
...
public abstract class JSON implements JSONStreamAware, JSONAware {
    ...
    public static JSONObject parseObject(String text) {
        ...
        try {
            return (JSONObject) com.taobao.csp.third.com.alibaba.fastjson.JSON.toJSON(obj);
     ...
     * {@link #parseObject(String, Type, com.taobao.csp.third.com.alibaba.fastjson.parser.Feature[])}. If you have the Json in a {@link InputStream} instead of
     * a String, use {@link #parseObject(InputStream, Type, com.taobao.csp.third.com.alibaba.fastjson.parser.Feature[])} instead.
     *
     ...
     * {@link #parseObject(String, Class, com.taobao.csp.third.com.alibaba.fastjson.parser.Feature[])} instead. If you have the Json in a {@link InputStream} instead of
     * a String, use {@link #parseObject(InputStream, Type, com.taobao.csp.third.com.alibaba.fastjson.parser.Feature[])} instead.
     *
     ...
     * {@link Writer}, use {@link #writeJSONString(Writer, Object, com.taobao.csp.third.com.alibaba.fastjson.serializer.SerializerFeature[])} instead.
     *
    ...
    public static void writeJSONString(Writer writer, Object object, SerializerFeature... features) {
        writeJSONString(writer, object, com.taobao.csp.third.com.alibaba.fastjson.JSON.DEFAULT_GENERATE_FEATURE, features);
    }
    ...
    public String toString(SerializerFeature... features) {
        SerializeWriter out = new SerializeWriter(null, com.taobao.csp.third.com.alibaba.fastjson.JSON.DEFAULT_GENERATE_FEATURE, features);
    ...
    public static Object toJSON(Object javaObject, SerializeConfig config) {
        ...
        if (javaObject instanceof com.taobao.csp.third.com.alibaba.fastjson.JSON) {
            return javaObject;
        }
        ...
        if (javaObject instanceof JSONSerializable) {
            String json = com.taobao.csp.third.com.alibaba.fastjson.JSON.toJSONString(javaObject);
            return com.taobao.csp.third.com.alibaba.fastjson.JSON.parse(json);
        }
        ...
        String text = com.taobao.csp.third.com.alibaba.fastjson.JSON.toJSONString(javaObject);
        return com.taobao.csp.third.com.alibaba.fastjson.JSON.parse(text);
    }

    public static <T> T toJavaObject(com.taobao.csp.third.com.alibaba.fastjson.JSON json, Class<T> clazz) {
    ...
    public <T> T toJavaObject(Class<T> clazz) {
        if (clazz == JSONArray.class || clazz == com.taobao.csp.third.com.alibaba.fastjson.JSON.class || clazz == Collection.class || clazz == List.class) {
            return (T) this;
        }
