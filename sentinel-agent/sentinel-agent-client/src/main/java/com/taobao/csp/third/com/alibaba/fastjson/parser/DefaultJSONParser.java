...
import com.taobao.csp.third.com.alibaba.fastjson.parser.ParseContext;
...
import static com.taobao.csp.third.com.alibaba.fastjson.parser.JSONLexer.EOI;
import static com.taobao.csp.third.com.alibaba.fastjson.parser.JSONToken.*;
                    ...
                    if (lexer.token() == JSONToken.LITERAL_STRING) {
                        ...
                        if ("@".equals(ref)) {
                            ...
                            if (context.object != null) {
                                ...
                                setResolveStatus(com.taobao.csp.third.com.alibaba.fastjson.parser.DefaultJSONParser.NeedToResolve);
                            }
                        } else if ("$".equals(ref)) {
    ...
    public void checkListResolve(Collection array) {
        if (resolveStatus == NeedToResolve) {
            if (array instanceof List) {
                ...
                setResolveStatus(com.taobao.csp.third.com.alibaba.fastjson.parser.DefaultJSONParser.NONE);
            } else {
                ResolveTask task = getLastResolveTask();
        ...
        try {
            for (int i = 0;;++i) {
                ...
                if (key == JSON.DEFAULT_TYPE_KEY && !lexer.isEnabled(Feature.DisableSpecialKeyDetect)) {
                    ...
                    setResolveStatus(com.taobao.csp.third.com.alibaba.fastjson.parser.DefaultJSONParser.TypeNameRedirect);
