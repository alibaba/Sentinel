...
public class AntiCollisionHashMap<K, V> extends AbstractMap<K, V> implements
     ...
     */
    public Object clone() {
        com.taobao.csp.third.com.alibaba.fastjson.util.AntiCollisionHashMap<K, V> result = null;
        try {
            result = (com.taobao.csp.third.com.alibaba.fastjson.util.AntiCollisionHashMap<K, V>) super.clone();
    ...
    private abstract class HashIterator<E> implements Iterator<E> {
        ...
        public void remove() {
            ...
            current = null;
            com.taobao.csp.third.com.alibaba.fastjson.util.AntiCollisionHashMap.this.removeEntryForKey(k);
            expectedModCount = modCount;
        }
    ...
    private final class KeySet extends AbstractSet<K> {
        ...
        public boolean remove(Object o) {
            return com.taobao.csp.third.com.alibaba.fastjson.util.AntiCollisionHashMap.this.removeEntryForKey(o) != null;
        }

        public void clear() {
            com.taobao.csp.third.com.alibaba.fastjson.util.AntiCollisionHashMap.this.clear();
        }
    }
