...
import com.taobao.csp.third.com.alibaba.fastjson.PropertyNamingStrategy;
import com.taobao.csp.third.com.alibaba.fastjson.annotation.JSONField;
import com.taobao.csp.third.com.alibaba.fastjson.annotation.JSONType;
import com.taobao.csp.third.com.alibaba.fastjson.parser.DefaultJSONParser;
import com.taobao.csp.third.com.alibaba.fastjson.parser.Feature;
...
import com.taobao.csp.third.com.alibaba.fastjson.parser.deserializer.EnumDeserializer;
import com.taobao.csp.third.com.alibaba.fastjson.parser.deserializer.JavaBeanDeserializer;
import com.taobao.csp.third.com.alibaba.fastjson.parser.deserializer.ObjectDeserializer;
import com.taobao.csp.third.com.alibaba.fastjson.serializer.CalendarCodec;
import com.taobao.csp.third.com.alibaba.fastjson.serializer.SerializeBeanInfo;
import com.taobao.csp.third.com.alibaba.fastjson.serializer.SerializerFeature;
import com.taobao.csp.third.com.alibaba.fastjson.util.IOUtils;
import com.taobao.csp.third.com.alibaba.fastjson.util.ParameterizedTypeImpl;
...
public class TypeUtils{
    ...
    static{
        try{
            com.taobao.csp.third.com.alibaba.fastjson.util.TypeUtils.compatibleWithJavaBean = "true".equals(IOUtils.getStringProperty(IOUtils.FASTJSON_COMPATIBLEWITHJAVABEAN));
            com.taobao.csp.third.com.alibaba.fastjson.util.TypeUtils.compatibleWithFieldName = "true".equals(IOUtils.getStringProperty(IOUtils.FASTJSON_COMPATIBLEWITHFIELDNAME));
        } catch(Throwable e){
            // skip
        }
    }
    ...
    public static boolean isXmlField(Class clazz) {
        ...
        Annotation annotation = com.taobao.csp.third.com.alibaba.fastjson.util.TypeUtils.getAnnotation(clazz, class_XmlAccessorType);
        if (annotation == null) {
            return false;
        }
    ...
    public static Annotation getXmlAccessorType(Class clazz) {
        ...
        return  com.taobao.csp.third.com.alibaba.fastjson.util.TypeUtils.getAnnotation(clazz, class_XmlAccessorType);
    }
...
//    }
        ...
        try{
            if(obj instanceof String){
                ...
                if (deserializer instanceof EnumDeserializer) {
                    ...
                    return (T) enumDeserializer.getEnumByHashCode(com.taobao.csp.third.com.alibaba.fastjson.util.TypeUtils.fnv1a_64(name));
                }
    ...
    private static void addBaseClassMappings(){
        ...
        Class<?>[] classes = new Class[]{
                ...
                JSONObject.class,
                com.taobao.csp.third.com.alibaba.fastjson.JSONPObject.class,
                com.taobao.csp.third.com.alibaba.fastjson.JSONArray.class,
        };
    ...
    public static SerializeBeanInfo buildBeanInfo(Class<?> beanType //
        ...
        JSONType jsonType = com.taobao.csp.third.com.alibaba.fastjson.util.TypeUtils.getAnnotation(beanType,JSONType.class);
        String[] orders = null;
        final int features;
        ...
        if(jsonType != null){
            ...
            for(Class<?> supperClass = beanType.getSuperclass()
                ...
                JSONType superJsonType = com.taobao.csp.third.com.alibaba.fastjson.util.TypeUtils.getAnnotation(supperClass,JSONType.class);
            ...
            for(Class<?> interfaceClass : beanType.getInterfaces()){
                JSONType superJsonType = com.taobao.csp.third.com.alibaba.fastjson.util.TypeUtils.getAnnotation(interfaceClass,JSONType.class);
                if(superJsonType != null){
                    typeKey = superJsonType.typeKey();
                    if(typeKey.length() != 0){
                        break;
        ...
        List<com.taobao.csp.third.com.alibaba.fastjson.util.FieldInfo> fieldInfoList = fieldBased
                ? computeGettersWithFieldBase(beanType, aliasMap, false, propertyNamingStrategy) //
                : computeGetters(beanType, jsonType, aliasMap, fieldCacheMap, false, propertyNamingStrategy);
        com.taobao.csp.third.com.alibaba.fastjson.util.FieldInfo[] fields = new com.taobao.csp.third.com.alibaba.fastjson.util.FieldInfo[fieldInfoList.size()];
        fieldInfoList.toArray(fields);
        com.taobao.csp.third.com.alibaba.fastjson.util.FieldInfo[] sortedFields;
        List<com.taobao.csp.third.com.alibaba.fastjson.util.FieldInfo> sortedFieldList;
        if(orders != null && orders.length != 0){
            ...
            sortedFieldList = new ArrayList<com.taobao.csp.third.com.alibaba.fastjson.util.FieldInfo>(fieldInfoList);
            Collections.sort(sortedFieldList);
        }
        sortedFields = new com.taobao.csp.third.com.alibaba.fastjson.util.FieldInfo[sortedFieldList.size()];
    ...
    public static List<com.taobao.csp.third.com.alibaba.fastjson.util.FieldInfo> computeGettersWithFieldBase(
            Class<?> clazz, //
            Map<String,String> aliasMap, //
            boolean sorted, //
            PropertyNamingStrategy propertyNamingStrategy){
        Map<String, com.taobao.csp.third.com.alibaba.fastjson.util.FieldInfo> fieldInfoMap = new LinkedHashMap<String, com.taobao.csp.third.com.alibaba.fastjson.util.FieldInfo>();
    ...
    public static List<com.taobao.csp.third.com.alibaba.fastjson.util.FieldInfo> computeGetters(Class<?> clazz, Map<String,String> aliasMap){
        return computeGetters(clazz, aliasMap, true);
    }

    public static List<com.taobao.csp.third.com.alibaba.fastjson.util.FieldInfo> computeGetters(Class<?> clazz, Map<String,String> aliasMap, boolean sorted){
        JSONType jsonType = com.taobao.csp.third.com.alibaba.fastjson.util.TypeUtils.getAnnotation(clazz,JSONType.class);
        Map<String,Field> fieldCacheMap = new HashMap<String,Field>();
    ...
    public static List<com.taobao.csp.third.com.alibaba.fastjson.util.FieldInfo> computeGetters(Class<?> clazz, //
                                                                           JSONType jsonType, //
                                                                           Map<String,String> aliasMap, //
        ...
        Map<String, com.taobao.csp.third.com.alibaba.fastjson.util.FieldInfo> fieldInfoMap = new LinkedHashMap<String, com.taobao.csp.third.com.alibaba.fastjson.util.FieldInfo>();
        boolean kotlin = com.taobao.csp.third.com.alibaba.fastjson.util.TypeUtils.isKotlin(clazz);
        // for kotlin
        ...
        for(Method method : methods){
            ...
            JSONField annotation = com.taobao.csp.third.com.alibaba.fastjson.util.TypeUtils.getAnnotation(method, JSONField.class);
            if(annotation == null){
            ...
            if(annotation == null && kotlin){
                if(constructors == null){
                    ...
                    Constructor creatorConstructor = com.taobao.csp.third.com.alibaba.fastjson.util.TypeUtils.getKoltinConstructor(constructors);
                    if(creatorConstructor != null){
                        paramAnnotationArrays = com.taobao.csp.third.com.alibaba.fastjson.util.TypeUtils.getParameterAnnotations(creatorConstructor);
                        paramNames = com.taobao.csp.third.com.alibaba.fastjson.util.TypeUtils.getKoltinConstructorParameters(clazz);
                        if(paramNames != null){
                ...
                if(paramNames != null && paramNameMapping != null && methodName.startsWith("get")){
                    ...
                    if(p >= 0){
                        ...
                        if(annotation == null){
                            ...
                            if(field != null){
                                annotation = com.taobao.csp.third.com.alibaba.fastjson.util.TypeUtils.getAnnotation(field, JSONField.class);
                            }
                        }
                    }
                }
            ...
            if(annotation != null){
                ...
                if(annotation.name().length() != 0){
                    ...
                    com.taobao.csp.third.com.alibaba.fastjson.util.FieldInfo fieldInfo = new com.taobao.csp.third.com.alibaba.fastjson.util.FieldInfo(propertyName, method, null, clazz, null, ordinal,
            ...
            if(methodName.startsWith("get")){
                ...
                if(field != null){
                    fieldAnnotation = com.taobao.csp.third.com.alibaba.fastjson.util.TypeUtils.getAnnotation(field, JSONField.class);
                ...
                com.taobao.csp.third.com.alibaba.fastjson.util.FieldInfo fieldInfo = new com.taobao.csp.third.com.alibaba.fastjson.util.FieldInfo(propertyName, method, field, clazz, null, ordinal, serialzeFeatures, parserFeatures,
    ...
    private static List<com.taobao.csp.third.com.alibaba.fastjson.util.FieldInfo> getFieldInfos(Class<?> clazz, boolean sorted, Map<String, com.taobao.csp.third.com.alibaba.fastjson.util.FieldInfo> fieldInfoMap){
        List<com.taobao.csp.third.com.alibaba.fastjson.util.FieldInfo> fieldInfoList = new ArrayList<com.taobao.csp.third.com.alibaba.fastjson.util.FieldInfo>();
        String[] orders = null;
        JSONType annotation = com.taobao.csp.third.com.alibaba.fastjson.util.TypeUtils.getAnnotation(clazz,JSONType.class);
        if(annotation != null){
            orders = annotation.orders();
        }
        if(orders != null && orders.length > 0){
            LinkedHashMap<String, com.taobao.csp.third.com.alibaba.fastjson.util.FieldInfo> map = new LinkedHashMap<String, com.taobao.csp.third.com.alibaba.fastjson.util.FieldInfo>(fieldInfoList.size());
            for(com.taobao.csp.third.com.alibaba.fastjson.util.FieldInfo field : fieldInfoMap.values()){
                map.put(field.name, field);
            }
            int i = 0;
            for(String item : orders){
                com.taobao.csp.third.com.alibaba.fastjson.util.FieldInfo field = map.get(item);
                if(field != null){
                    fieldInfoList.add(field);
                    map.remove(item);
                }
            }
            for(com.taobao.csp.third.com.alibaba.fastjson.util.FieldInfo field : map.values()){
                fieldInfoList.add(field);
            }
        } else{
            for(com.taobao.csp.third.com.alibaba.fastjson.util.FieldInfo fieldInfo : fieldInfoMap.values()){
    ...
    private static void computeFields(
            ...
            Map<String,String> aliasMap, //
            PropertyNamingStrategy propertyNamingStrategy, //
            Map<String, com.taobao.csp.third.com.alibaba.fastjson.util.FieldInfo> fieldInfoMap, //
            Field[] fields){
        for(Field field : fields){
            if(Modifier.isStatic(field.getModifiers())){
                continue;
            }
            JSONField fieldAnnotation = com.taobao.csp.third.com.alibaba.fastjson.util.TypeUtils.getAnnotation(field, JSONField.class);
            int ordinal = 0, serialzeFeatures = 0, parserFeatures = 0;
            ...
            if(!fieldInfoMap.containsKey(propertyName)){
                com.taobao.csp.third.com.alibaba.fastjson.util.FieldInfo fieldInfo = new com.taobao.csp.third.com.alibaba.fastjson.util.FieldInfo(propertyName, null, field, clazz, null, ordinal, serialzeFeatures, parserFeatures,
        ...
        if(interfaces.length > 0){
            ...
            for(Class<?> interfaceClass : interfaces){
                for(Method interfaceMethod : interfaceClass.getMethods()){
                    ...
                    JSONField annotation = com.taobao.csp.third.com.alibaba.fastjson.util.TypeUtils.getAnnotation(interfaceMethod, JSONField.class);
                    if(annotation != null){
                        return annotation;
                    }
                }
    ...
    private static Type getActualType(Type typeParameter, Map<TypeVariable, Type> actualTypeMap) {
        if (typeParameter instanceof TypeVariable) {
            ...
            return new com.taobao.csp.third.com.alibaba.fastjson.util.GenericArrayTypeImpl(getActualType(((GenericArrayType) typeParameter).getGenericComponentType(), actualTypeMap));
        }
    ...
    public static boolean isTransient(Method method){
        ...
        if(transientClass != null){
            Annotation annotation = com.taobao.csp.third.com.alibaba.fastjson.util.TypeUtils.getAnnotation(method, transientClass);
