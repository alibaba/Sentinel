...
import com.taobao.csp.third.com.alibaba.fastjson.support.hsf.MethodLocator;
import com.taobao.csp.third.com.alibaba.fastjson.util.TypeUtils;

import java.lang.reflect.Method;
import java.lang.reflect.Type;

import static com.taobao.csp.third.com.alibaba.fastjson.parser.JSONLexer.NOT_MATCH_NAME;
    ...
    public static Object[] parseInvocationArguments(String json, MethodLocator methodLocator) {
        ...
        if (token == JSONToken.LBRACE) {
            ...
            if (typeNames == null && lexer.matchStat == NOT_MATCH_NAME) {
                ...
                if ("com.taobao.csp.third.com.alibaba.fastjson.JSONObject".equals(type)) {
