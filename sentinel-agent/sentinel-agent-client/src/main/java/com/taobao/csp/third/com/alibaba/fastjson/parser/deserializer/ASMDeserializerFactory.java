...
import com.taobao.csp.third.com.alibaba.fastjson.asm.*;
...
import com.taobao.csp.third.com.alibaba.fastjson.util.ASMClassLoader;
...
import static com.taobao.csp.third.com.alibaba.fastjson.util.ASMUtils.desc;
import static com.taobao.csp.third.com.alibaba.fastjson.util.ASMUtils.type;
...
public class ASMDeserializerFactory implements Opcodes {
    ...
    public ObjectDeserializer createJavaBeanDeserializer(ParserConfig config, JavaBeanInfo beanInfo) throws Exception {
        ...
        Package pkg = com.taobao.csp.third.com.alibaba.fastjson.parser.deserializer.ASMDeserializerFactory.class.getPackage();
        if (pkg != null) {
    ...
    private void _deserialzeArrayMapping(ClassWriter cw, Context context) {
        ...
        for (int i = 0; i < fieldListSize; ++i) {
            ...
            if (fieldClass == byte.class //
                ...
                mw.visitLdcInsn(com.taobao.csp.third.com.alibaba.fastjson.parser.JSONLexerBase.VALUE_NULL);
                ...
                mw.visitVarInsn(ALOAD, context.var("lexer"));
                mw.visitLdcInsn(com.taobao.csp.third.com.alibaba.fastjson.asm.Type.getType(desc(fieldClass)));
                ...
                if (itemClass == String.class) {
                    ...
                    mw.visitVarInsn(ALOAD, 1);
                    mw.visitLdcInsn(com.taobao.csp.third.com.alibaba.fastjson.asm.Type.getType(desc(itemClass)));
...
//                mw.visitInsn(POP);
    ...
    private void _deserialze(ClassWriter cw, Context context) {
        ...
        mw.visitLdcInsn(com.taobao.csp.third.com.alibaba.fastjson.parser.JSONLexerBase.NOT_MATCH);
        ...
        mw.visitVarInsn(ALOAD, context.var("lexer"));
        mw.visitFieldInsn(GETFIELD, JSONLexerBase, "matchStat", "I");
        mw.visitLdcInsn(com.taobao.csp.third.com.alibaba.fastjson.parser.JSONLexerBase.END);
...
//                mw.visitLabel(enumNull_);
                ...
                if (itemClass == String.class) {
                    mw.visitLdcInsn(com.taobao.csp.third.com.alibaba.fastjson.asm.Type.getType(desc(fieldClass))); // cast
    ...
    private void _deserialze_list_obj(Context context, MethodVisitor mw, Label reset_, FieldInfo fieldInfo,
        ...
        mw.visitVarInsn(ALOAD, 1);
        mw.visitLdcInsn(com.taobao.csp.third.com.alibaba.fastjson.asm.Type.getType(desc(itemType)));
        mw.visitInsn(ICONST_0);
        mw.visitMethodInsn(INVOKESTATIC, "java/lang/Integer", "valueOf", "(I)Ljava/lang/Integer;");
    ...
    private void _deserialze_obj(Context context, MethodVisitor mw, Label reset_, FieldInfo fieldInfo,
        ...
        mw.visitLdcInsn(com.taobao.csp.third.com.alibaba.fastjson.parser.DefaultJSONParser.NeedToResolve);
        ...
        mw.visitVarInsn(ALOAD, 1);
        mw.visitLdcInsn(com.taobao.csp.third.com.alibaba.fastjson.parser.DefaultJSONParser.NONE);
    ...
    private void _deserObject(Context context, MethodVisitor mw, FieldInfo fieldInfo, Class<?> fieldClass, int i) {
        ...
        if ((fieldInfo.parserFeatures & Feature.SupportArrayToBean.mask) != 0) {
            ...
            if (fieldInfo.fieldType instanceof Class) {
                mw.visitLdcInsn(com.taobao.csp.third.com.alibaba.fastjson.asm.Type.getType(desc(fieldInfo.fieldClass)));
            } else {
                mw.visitVarInsn(ALOAD, 0);
                mw.visitLdcInsn(i);
                mw.visitMethodInsn(INVOKEVIRTUAL, type(JavaBeanDeserializer.class), "getFieldType",
