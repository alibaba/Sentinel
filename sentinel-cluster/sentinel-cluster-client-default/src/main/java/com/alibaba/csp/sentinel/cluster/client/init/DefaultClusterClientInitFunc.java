...
public class DefaultClusterClientInitFunc implements InitFunc {
    ...
    private void initDefaultEntityWriters() {
        ...
        String maxParamBySize = SentinelConfig.getConfig(SentinelConfig.MAX_PARAM_BYTE_SIZE);
        RequestDataWriterRegistry.addWriter(ClientConstants.TYPE_PARAM_FLOW, new ParamFlowRequestDataWriter(Integer.valueOf(maxParamBySize)));
    }
