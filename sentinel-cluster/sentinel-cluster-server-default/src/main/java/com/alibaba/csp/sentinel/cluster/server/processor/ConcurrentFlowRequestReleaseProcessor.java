...
public class ConcurrentFlowRequestReleaseProcessor implements RequestProcessor<ConcurrentFlowReleaseRequestData, Object> {
    @Override
    public ClusterResponse processRequest(ChannelHandlerContext ctx, ClusterRequest<ConcurrentFlowReleaseRequestData> request) {
