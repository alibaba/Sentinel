...
public class BlockRequestWaitQueue {
    /**
     * block queue to store the request information.
     */
    ...
    public static boolean addClientRequestToWaitQueue(final RequestInfoEntity requestObject) {
        return blockingQueue.offer(requestObject);
    }

    public static TokenResult addServerRequestToWaitQueue(String address, int count, long flowId, boolean prioritized) {
            ...
            public void run() {
                ...
                while (true) {
                    try {
                        ...
                        if (rule == null) {
                            ClusterServerStatLogUtil.log("concurrent|queue|block|" + flowId, res.getRequest().getData().getCount());
                        ...
                        ClusterServerStatLogUtil.log("concurrent|queue|pass|" + flowId, acquireCount);
    ...
    private static void applyResult(/*@Valid*/ RequestInfoEntity entity, TokenResult result) {
