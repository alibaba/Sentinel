...
import static com.alibaba.csp.sentinel.cluster.redis.RedisSingleTestUtil.initJedisClient;
import static com.alibaba.csp.sentinel.cluster.redis.RedisSingleTestUtil.initRedisConf;
import static com.alibaba.csp.sentinel.cluster.redis.util.ClientConstants.*;
import static org.junit.Assert.assertEquals;

public class RedisFlowRuleManagerInSingleTest {
//    @Test
    ...
    public FlowRule getRule(long flowId) throws NoSuchFieldException, IllegalAccessException {
        Jedis jedis = initJedisClient();
        Map<String, String> map = jedis.hgetAll(LuaUtil.toLuaParam(FLOW_RULE_CONFIG_KEY, flowId));
